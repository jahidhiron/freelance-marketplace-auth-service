...
import { BadRequestError, IAuthDocument, IEmailMessageDetails, firstLetterUppercase, lowerCase, uploads } from '@jahidhiron/jobber-shared';
...
export async function create(req: Request, res: Response): Promise<void> {
  ...
  const uploadResult = (await uploads(profilePicture, `${profilePublicId}`, true, true)) as UploadApiResponse;
  ...
  const result = (await createAuthUser(authData)) as IAuthDocument;
